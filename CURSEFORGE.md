...
![Split Categories](images/buffs-split-groups.png)

## Configuration

To open the options panel, type `/brv2`
...
![BuffRemindersV2 Settings - Buffs](images/settings-buffs.png)
...
![BuffRemindersV2 Settings - Options](images/settings-options.png)
