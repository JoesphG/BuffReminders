...
local function CreateOptionsPanel()
    local panel = CreatePanel("BuffRemindersV2Options", PANEL_WIDTH, 597, { escClose = true })
    panel:Hide()
    ...
    for _, category in ipairs(CATEGORY_ORDER) do
        ...
        if category == "pet" then
            ...
            local passiveCombatHolder = Components.Checkbox(catContent, {
                ...
                get = function()
                    return BuffRemindersV2DB.petPassiveOnlyInCombat == true
                end,
                tooltip = {
                ...
                onChange = function(checked)
                    BuffRemindersV2DB.petPassiveOnlyInCombat = checked
                    UpdateDisplay()
                end,
            })
    ...
    function lockBtn:Refresh()
        self.text:SetText(BuffRemindersV2DB.locked and "Unlock" or "Lock")
    end
    lockBtn:Refresh()
