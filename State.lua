...
-- ============================================================================
-- PET ACTION HELPERS (ClickableRaidBuffs-inspired)
-- ============================================================================
...
local function IsMMWithoutUnbreakableBond()
    ...
    return not IsPlayerSpellCached(HUNTER_DISABLE_PETS_SPELL)
end
...
-- Shared via BR namespace: also used by BuffRemindersV2.lua for the display icon
